...
regular         : dependencies used for compilation and for runtime as well. This is the most common place to declare dependencies.
compile_only    : dependencies used for compilation but not for runtime
runtime_only    : dependencies used for runtime but not for compilation.
