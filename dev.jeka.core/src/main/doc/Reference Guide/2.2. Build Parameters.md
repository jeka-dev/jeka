...
To get a precise idea on how types are converted see [this code](https://github.com/jeka/jeka/blob/master/org.jeka.core/src/main/java/org/jeka/tool/OptionInjector.java).
