...
public class ResolvePopularDependenciesIT {
    ...
    public void apacheHttpClient() {
        JkResolveResult result = resolver().resolve(
                JkDependencySet.of("org.apache.httpcomponents:httpclient:4.5.3")
    ...
    public void apacheHttpClientWithTestToTestScopeMapping() {
        JkScopeMapping scopeMap = JkScopeMapping.of("test").to("archive", "test");
        JkScopedDependency scopedDep = JkScopedDependency.of(JkModuleDependency.of("org.apache.httpcomponents:httpclient:4.5.3"))
                .withScopeMapping(scopeMap);
        JkDependencySet deps =  JkDependencySet.of().and(scopedDep);
