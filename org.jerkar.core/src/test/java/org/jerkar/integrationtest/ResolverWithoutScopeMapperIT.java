...
public class ResolverWithoutScopeMapperIT {
    ...
    public void resolveCompile() {
        ...
        assertEquals(10, resolveResult.getDependencyTree().getResolvedVersion().moduleIds().size());
    }
    ...
    public void resolveWithOptionals() {
        ...
        JkResolveResult resolveResult = resolver.resolve(deps, COMPILE);
        assertEquals(37, resolveResult.getDependencyTree().getResolvedVersion().moduleIds().size());
    }
