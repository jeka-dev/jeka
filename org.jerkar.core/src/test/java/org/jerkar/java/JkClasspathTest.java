...
public class JkClasspathTest {
	...
	public void testEntriesContainingPath() throws Exception {
		...
		assertEquals(sampleJar, classpath.getEntryContainingClass("org.jerkar.JkBuildBase"));
		assertEquals(sampleJar, classpath.getEntryContainingClass("org.jerkar.JkBuildBase$ActionDescription"));
