...
/**
 * Key/value string storage for build parameters. Both keys and values are java {@link String}.
 * Parameters are stored in a static field so they are available from everywhere.
 * These parameters are consumed by the build definitions but not set here.<br/>
 * To define these values see <a href="http://jerkar.github.io/documentation/latest/reference.html">Jerkar Reference Guide section 3.3</a>
 */
public final class JkOptions {
	...
	/**
	 * Returns <code>true</code> if a value has been defined for the specified key.
	 */
