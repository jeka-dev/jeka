...
public final class JkBuildPlugins {
    ...
    private final List<JkBuildPlugin> configuredPlugins = new LinkedList<>();
    ...
    public <T extends JkBuildPlugin> T get(Class<T> pluginClass) {
        return getOrCreate(pluginClass, new HashMap<String, String>());
    }

    void invoke(JkBuildPlugin plugin, String methodName) {
    ...
    <T extends JkBuildPlugin> T getOrCreate(Class<T> pluginClass, Map<String, String> options) {
