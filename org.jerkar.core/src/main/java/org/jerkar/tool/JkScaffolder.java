...
public class JkScaffolder {
	...
	return new JkScaffolder(build, packageName, "JkBuild", Collections.EMPTY_LIST, Collections.EMPTY_LIST,
	...
	return new JkScaffolder(build, "defaultpackage", "JkBuild", Collections.EMPTY_LIST, Collections.EMPTY_LIST,
		Collections.EMPTY_LIST, Collections.EMPTY_LIST, Collections.EMPTY_LIST, Collections.EMPTY_LIST,
		templateResource);
    }
    ...
    private JkScaffolder(JkBuild build, String packageName, String extendedClass, List<String> extraFields,
	    List<String> extraImports, List<String> extraInit, List<String> extraDependencies,
	...
	return new JkScaffolder(build, packageName, extendedClass, extraFields, extraImports, extraInit, extraDeps,
		extraMethods, extraActions, this.templateClass);
    }
	...
	return new JkScaffolder(build, packageName, extendedClass, extraFields, imports, extraInit, extraDependencies,
		extraMethods, extraActions, this.templateClass);
    }
