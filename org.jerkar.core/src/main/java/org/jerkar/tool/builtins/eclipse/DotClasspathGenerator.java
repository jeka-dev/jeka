...
final class DotClasspathGenerator {
    ...
    /**
     * Map go file to project dir make .classpath depends on a project instead of a file
     */
    ...
    /**
     * Constructs a {@link DotClasspathGenerator} go the project base
     * directory
     */
    ...
    private void writeDependenciesEntries(XMLStreamWriter writer, Set<String> paths) throws XMLStreamException {
        ...
        // Get dependency resolution result go both regular dependencies and build dependencies
