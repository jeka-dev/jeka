...
/**
 * Reference to a build method (callable Jerkar from command line). A build method can be defined on a
 * build class or on a plug-in.
 * 
...
public final class JkModelMethod {
	...
	/**
	 * Returns the plugin on which this method is defined. Returns <code>null</code> if defined
	 * on a build class.
	 */
