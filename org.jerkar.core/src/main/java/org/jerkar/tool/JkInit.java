...
/**
 * Initializer for build instances. It instantiates build class and inject values
 * according command line and option files.
 */
public final class JkInit {
    ...
    /**
     * Creates an instance of the specified build class. the build instance is configured according specified
     * command line arguments and option files found in running environment.
     */
