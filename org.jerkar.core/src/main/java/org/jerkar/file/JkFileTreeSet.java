...
public final class JkFileTreeSet implements Iterable<File> {
	...
	/**
	 * Creates a {@link JkFileTreeSet} which is a concatenation of this {@link JkFileTreeSet} and
	 * the {@link JkFileTree} array passed as parameter.
	 */
	...
	/**
	 * Creates a {@link JkFileTreeSet} which is a concatenation of this {@link JkFileTreeSet} and
	 * the {@link JkFileTreeSet} array passed as parameter.
	 */
	...
	/**
	 * Returns path of each files file contained in this {@link JkFileTreeSet} relative to the
	 * root of their respective {@link JkFileTree}.
	 */
	...
	/**
	 * Returns root of each {@link JkFileTree} instances constituting this {@link JkFileTreeSet}.
	 */
	...
	/**
	 * Returns a {@link JkZipper} made of the files contained in this {@link JkFileTreeSet}.
	 */
	public JkZipper zip() {
	...
	/**
	 * Returns <code>true</code> if each {@link JkFileTree} constituting this {@link JkFileTreeSet} exist.
	 * 
	...
	/**
	 * Returns a the root of all {@link JkFileTree} constituting this {@link JkFileTreeSet}.
	 */
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((jkFileTrees == null) ? 0 : jkFileTrees.hashCode());
		return result;
	}
