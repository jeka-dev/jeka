...
/**
 * Set of repositories to publish to. When publishing you may want deploy your artifact on to a repository or another
...
public final class JkPublishRepos implements Iterable<JkPublishRepo>, Serializable {
	...
	public static JkPublishRepos ossrh(String userName, String password, JkPgp pgp) {
		final JkPublishRepo snapshot = JkPublishRepo.ofSnapshot(
				...
				.andSha1Md5Checksums()
				.withUniqueSnapshot(true);  // ignored as unique timestamped snapshot not yet supported
