...
public final class JkMavenPublication implements Serializable {
	...
	if (JkUtilsString.isBlank(fileExt)) {
	    throw new IllegalArgumentException(
		    "the file " + file.getPath() + " must have an extension (as .jar, .zip, ...");
	}
	if (contains(fileExt, classifier)) {
	    throw new IllegalArgumentException("Can't add artifact with extension/classifier equals to [" + fileExt
