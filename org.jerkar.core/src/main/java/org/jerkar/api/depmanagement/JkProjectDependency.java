...
public class JkProjectDependency extends JkFileDependency {

	public static final JkProjectDependency of(final JkProcess process, File ...files) {
		...
		return new JkProjectDependency(runnable, fileSet);
	}

	public static final JkProjectDependency of(File file,  final JkJavaProcess process,
			final String className, final String ...args) {
		return of(JkUtilsIterable.setOf(file), process, className, args);
	}

	public static final JkProjectDependency of(Runnable runnable, File ...files) {
		final Set<File> fileSet = JkUtilsIterable.setOf(files);
		return new JkProjectDependency(runnable, fileSet);
	}


	public static final JkProjectDependency of(Set<File> files, final JkJavaProcess process,
			final String className, final String ...args) {
		final Set<File> fileSet = JkUtilsIterable.setOf(files);
		final Runnable runnable = new Runnable() {
	...
	protected JkProjectDependency(Runnable runnable, Set<File> files) {
		super();
