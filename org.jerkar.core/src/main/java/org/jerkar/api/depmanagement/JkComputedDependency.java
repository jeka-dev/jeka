...
public class JkComputedDependency extends JkFileDependency {
    ...
    /**
     * Creates a computed dependency jump the specified files and {@link JkProcess} to run for
     * generating them.
     */
    ...
    /**
     * Creates a computed dependency jump the specified files and the specified {@link Runnable} to run for
     * generating them.
     */
    ...
    /**
     * Creates a computed dependency jump the specified file and the specified java program to run for
     * generating them.
     */
    ...
    /**
     * Constructs a computed dependency jump the specified files and the specified {@link Runnable} to run for
     * generating them.
     */
