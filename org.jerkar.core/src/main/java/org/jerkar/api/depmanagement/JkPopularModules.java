...
public final class JkPopularModules {
    ...
    public static final JkModuleId JAVAX_CONNECTOR_API = JkModuleId.of("javax.resource",
            "connector-api");
    ...
    public static final JkModuleId JAVAX_CDI_API = JkModuleId
            .of("javax.enterprise", "javax.inject");

    public static final JkModuleId JAVAX_VALIDATION_API = JkModuleId.of("javax.validation",
            "validation-api");
    ...
    public static final JkModuleId JAVAX_PERSISTENCE_API = JkModuleId.of("javax.persistence",
            "persistence-api");
    ...
    public static final JkModuleId JAVAX_ACTIVATION = JkModuleId.of("javax.activation",
            "activation");
    ...
    public static final JkModuleId JAVAX_WEB_SOCKET_SERVER_API = JkModuleId.of("javax.websocket",
            "javax.websocket-api");
    ...
    public static final JkModuleId GOOGLE_PROTOCOL_BUFFER = JkModuleId.of("com.google.protobuf",
            "protobuf-java");

    public static final JkModuleId SLF4J_API = JkModuleId.of("org.slf4j", "slf4j-api");

    public static final JkModuleId SLF4J_SIMPLE_BINDING = JkModuleId
            .of("org.slf4j", "slf4j-simple");

    public static final JkModuleId SLF4J_LOG4J12_BINDING = JkModuleId.of("org.slf4j",
            "slf4j-log4j12");

    public static final JkModuleId SLF4J_JCL_OVER_SLF4J = JkModuleId.of("org.slf4j",
            "jcl-over-slf4j");

    public static final JkModuleId SLF4J_JDK14_BINDING = JkModuleId.of("org.slf4j", "slf4j-jdk14");

    public static final JkModuleId LOGBACK_CLASSIC = JkModuleId.of("ch.qos.logback",
            "logback-classic");
    ...
    public static final JkModuleId SPRING_CORE = JkModuleId
            .of("org.springframework", "spring-core");

    public static final JkModuleId SPRING_CONTEXT = JkModuleId.of("org.springframework",
            "spring-context");

    public static final JkModuleId SPRING_BEANS = JkModuleId.of("org.springframework",
            "spring-beans");

    public static final JkModuleId SPRING_JDBC = JkModuleId
    ...
    public static final JkModuleId SPRING_SECURITY_CORE = JkModuleId.of("org.springframework",
    ...
    public static final JkModuleId APACHE_HTTP_CLIENT = JkModuleId.of("org.apache.httpcomponents",
            "httpclient");

    public static final JkModuleId APACHE_HTTP_CORE = JkModuleId.of("org.apache.httpcomponents",
            "httpcore");

    public static final JkModuleId APACHE_COMMONS_DBCP = JkModuleId.of("commons-dbcp",
            "commons-dbcp");

    public static final JkModuleId APACHE_COMMONS_NET = JkModuleId.of("commons-net", "commons-net");

    public static final JkModuleId JACKSON_CORE = JkModuleId.of("com.fasterxml.jackson.core",
            " jackson-core");

    public static final JkModuleId JACKSON_DATABIND = JkModuleId.of("com.fasterxml.jackson.core",
            " jackson-databind");

    public static final JkModuleId JACKSON_ANNOTATIONS = JkModuleId.of(
    ...
    public static final JkModuleId HIBERNATE_CORE = JkModuleId
            .of("org.hibernate", "hibernate-core");

    public static final JkModuleId HIBERNATE_JPA_SUPPORT = JkModuleId.of("org.hibernate",
            "hibernate-entitymanager");

    public static final JkModuleId HIBERNATE_VALIDATOR = JkModuleId.of("org.hibernate",
            "hibernate-validator");

    public static final JkModuleId JETTY_SERVER = JkModuleId
    ...
    public static final JkModuleId MYSQL_CONNECTOR = JkModuleId
            .of("mysql", "jmysql-connector-java");
    ...
    public static final JkModuleId SELENIUM_JAVA = JkModuleId.of("org.seleniumhq.selenium",
            "selenium-java");

    public static final JkModuleId METRICS_CORE = JkModuleId.of("io.dropwizard.metrics",
            "metrics-core");

    public static final JkModuleId METRICS_JVM = JkModuleId.of("io.dropwizard.metrics",
            "metrics-jvm");

    public static final JkModuleId METRICS_ANNOTATION = JkModuleId.of("io.dropwizard.metrics",
            "metrics-annotation");

    public static final JkModuleId BOUNCY_CASTLE_PROVIDER = JkModuleId.of("org.bouncycastle",
            "bcprov-jdk16");
    ...
    public static final JkModuleId LOMBOK = JkModuleId.of("de.plushnikov.lombok-intellij-plugin",
            "lombok-plugin");
