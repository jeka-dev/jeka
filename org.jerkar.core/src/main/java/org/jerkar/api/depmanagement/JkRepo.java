...
public abstract class JkRepo implements Serializable {
	...
	private JkIvyRepository(URL url, String realm, String username, String password, List<String> artifactPatterns,
		List<String> ivyPatterns) {
	    super(url, realm, username, password);
	...
	public JkIvyRepository ivyPatterns(String... patterns) {
	    return new JkIvyRepository(this.url(), this.realm(), this.userName(), this.password(), artifactPatterns,
	...
	@Override
	public JkRepo withCredential(String username, String password) {
	    return new JkIvyRepository(this.url(), this.realm(), username, password, this.artifactPatterns,
		    this.ivyPatterns);
	}

	@Override
	public JkRepo withRealm(String realm) {
	    return new JkIvyRepository(this.url(), realm, this.userName(), this.password(), this.artifactPatterns,
		    this.ivyPatterns);
	}
