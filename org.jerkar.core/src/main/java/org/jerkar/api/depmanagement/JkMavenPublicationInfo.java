...
public final class JkMavenPublicationInfo implements Serializable {
    ...
    private JkMavenPublicationInfo(JkProjectInfo project, JkScmInfo scm, List<JkDeveloperInfo> devs,
	    List<JkLicenseInfo> licenses) {
	super();
	...
	public JkDeveloperInfo(String name, String email, String organisation, String organisationUrl) {
	    super();
	    this.name = name;
	    this.email = email;
