...
public final class JkJavaProcess {
	...
	return new JkJavaProcess(javaDir, Collections.EMPTY_MAP, JkClasspath.of(), Collections.EMPTY_LIST,
	...
	if (!agentLib.isFile()) {
	    throw new IllegalArgumentException(
		    "aggentLib " + agentLib.getAbsolutePath() + " is a directory, should be a file.");
	}
	...
	return new JkJavaProcess(this.javaDir, this.sytemProperties, this.classpath, list, this.options,
	...
	list.addAll(options);
	return new JkJavaProcess(this.javaDir, this.sytemProperties, this.classpath, this.agents, list, this.workingDir,
		this.environment);
    }
	...
	return new JkJavaProcess(this.javaDir, this.sytemProperties, this.classpath, this.agents, this.options,
		workingDir, this.environment);
    }
	...
	return new JkJavaProcess(this.javaDir, this.sytemProperties, jkClasspath, this.agents, this.options,
		this.workingDir, this.environment);
    }
