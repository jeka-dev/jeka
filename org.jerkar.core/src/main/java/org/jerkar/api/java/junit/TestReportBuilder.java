...
final class TestReportBuilder {
	...
	final StringBuilder builder = new StringBuilder(TEXT_HEAD).append("\n").append("Test set: ")
		.append(result.suiteName()).append("\n").append(TEXT_HEAD).append("\n").append("Tests run: ")
		.append(result.runCount()).append(", ").append("Failures: ").append(result.assertErrorCount())
		.append(", ").append("Errors: ").append(result.errorCount()).append(", ").append("Skipped: ")
