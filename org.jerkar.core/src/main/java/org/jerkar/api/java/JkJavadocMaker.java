...
public final class JkJavadocMaker {
    ...
    private JkJavadocMaker(JkFileTreeSet srcDirs, Class<?> doclet, Iterable<File> classpath, String extraArgs,
	    File outputDir, File zipFile) {
	...
	final Method method = JkUtilsReflect.getMethod(mainClass, "execute", String.class, PrintWriter.class,
		PrintWriter.class, PrintWriter.class, String.class, new String[0].getClass());
