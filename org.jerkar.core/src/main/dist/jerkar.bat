...
set "COMMAND="%JAVA_CMD%" %JERKAR_OPTS% -cp "%LOCAL_BUILD_DIR%%JERKAR_HOME%org.jerkar.core-fat.jar;%JERKAR_HOME%libs\required\*;%JERKAR_HOME%libs\ext\*" org.jerkar.Main %*"
