 ...
 * It can't be compiled by Jerkar cause it refers to classes file from this project.
 * That's why its name start with '_' (java source starting with '_' are not compiled by Jerkar).
 */
