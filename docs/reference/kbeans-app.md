...
```shell
jeka app: install repo=REPO_URL native:
```
...
`catalog.xxx.repo` can be a URL pointing to the catalog file, or the URL of the *GitHub* repo containing the catalog file.
