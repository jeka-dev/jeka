...
In order to leverage new features bring by these versions, **Jerkar is deeply reworked**. 
Also, to avoid bloating API with legacy stuff, Jerkar 0.7 won't be compatible with Jerkar 0.6 (builds written with this version still can be run using embedded mode). 
