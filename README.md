...
perfoms a complete buid running unit tests under Jacoco coverage tools and performs Sonar analysis on a project free of any build code/sonfiguration/script. 
