...
final class DotClasspath {
	...
	private static void generate(JakeJavaBuild build, File outputFile) throws IOException, XMLStreamException, FactoryConfigurationError {
		...
		writer.writeComment("Generated by Jake.");
