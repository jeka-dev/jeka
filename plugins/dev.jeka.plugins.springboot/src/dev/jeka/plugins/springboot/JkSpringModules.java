...
public final class JkSpringModules {
    ...
    public static class Fwk {
        ...
        public static final JkModuleId AOP = groupAndName("spring-aop");

        public static final JkModuleId ASPECTS = groupAndName("spring-aspects");

        public static final JkModuleId BEANS = groupAndName("spring-beans");

        public static final JkModuleId CONTEXT = groupAndName("spring-context");

        public static final JkModuleId CONTEXT_SUPPORT = groupAndName("spring-context-support");

        public static final JkModuleId CORE = groupAndName("spring-core");

        public static final JkModuleId EXPRESSION = groupAndName("spring-expression");

        public static final JkModuleId INSTRUMENT = groupAndName("spring-instrument");

        public static final JkModuleId INSTRUMENT_TOMCAT = groupAndName("spring-instrument-tomcat");

        public static final JkModuleId JDBC = groupAndName("spring-jdbc");

        public static final JkModuleId JMS = groupAndName("spring-jms");

        public static final JkModuleId MESSAGING = groupAndName("spring-messaging");

        public static final JkModuleId ORM = groupAndName("spring-orm");

        public static final JkModuleId OXM = groupAndName("spring-oxm");

        public static final JkModuleId TEST = groupAndName("spring-test");

        public static final JkModuleId TX = groupAndName("spring-tx");

        public static final JkModuleId WEB = groupAndName("spring-web");

        public static final JkModuleId WEBMVC = groupAndName("spring-webmvc");

        public static final JkModuleId WEBMVC_PORTLET = groupAndName("spring-webmvc-portlet");

        public static final JkModuleId WEBSOCKET = groupAndName("spring-websocket");

        private static final JkModuleId groupAndName(String name) {
