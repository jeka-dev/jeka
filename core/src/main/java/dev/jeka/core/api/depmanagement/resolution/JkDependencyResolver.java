...
public final class JkDependencyResolver  {
    ...
    public final List<UnaryOperator<JkResolveResult>> resolveResultCustomizers = new LinkedList<>();
    ...
    /**
     * Returns the default resolution parameters for this dependency resolver.
     */
    ...
    public JkResolveResult resolve(JkQualifiedDependencySet qualifiedDependencies, JkResolutionParameters params) {
        ...
        try {
            ...
            for (UnaryOperator<JkResolveResult> customizer : resolveResultCustomizers) {
